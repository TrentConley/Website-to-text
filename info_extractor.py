...
class InformationExtractor:
    ...
    def extract(self, query, text):
        ...
        messages = [
            {"role": "system", "content": "You are given a certin text that comes from a screenshot of a website. The user is looking for their query. Even if you only capture part of it, return that. Keep your answers brief and just to the information they requested."},
    ...
    def extract_from_history(self, past_extractions, query):
        ...
        for extraction in past_extractions:
            messages.append({"role": "user", "content": f"Past Extraction: {extraction}"})
